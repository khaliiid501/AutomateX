"""
Tests for the task_notifier module.

Validates email notification sending and deadline checking logic.
"""
...
from src.task_notifier import send_email_notification, check_task_deadlines
